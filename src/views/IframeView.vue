...
<template>
  <table class="pk-party" v-if="param['format'] === 'party'">
    ...
    <tr class="pk-party">
      <td class="pk-party image-area" rowspan="2"><img class="pk-party" v-bind:src="'https://easmois2332.github.io/pk-assets/image/Pokemon/Normal/' + getImage(party[i]['pokemon'], party[i]['gender']) + '.png'" v-bind:alt="party[i]['pokemon']"></td>
  ...
  <table class="pk-detail" v-if="param['format'] === 'detail'">
    ...
    <tr class="pk-detail" v-bind:class="color + '-1'">
      ...
      <td class="pk-detail image-area" rowspan="4"><img class="pk-detail" v-bind:src="'https://easmois2332.github.io/pk-assets/image/Pokemon/Normal/' + getImage(detail['pokemon'], detail['gender']) + '.png'" v-bind:alt="detail['pokemon']"></td>
    </tr>
